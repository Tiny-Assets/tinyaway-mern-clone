...
import { useConstructQuery } from "../../../hooks/uesConstructQuery";
import DateLightBox from "./DateLightBox";
    ...
    return(
        <>      
            <SearchGrid>
                ...
                <SearchField fieldName='DATE' toDo={ toggleDateMenu } arrow/>
